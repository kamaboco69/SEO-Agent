...
// /api/agent/ は AI Company サーバー間ブリッジ。HMACトークン（Bearer）による認可をエンドポイント内で行う。
const PUBLIC_PATHS = ["/login", "/sso", "/api/sso/", "/api/wp/", "/api/auth/", "/api/analyst/recommendations", "/api/schedule/tick", "/api/agent/"];
